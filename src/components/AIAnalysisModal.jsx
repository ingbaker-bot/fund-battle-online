...
import { X, Sparkles, Trophy, TrendingUp, TrendingDown, Activity, Target, Lightbulb, Loader2, Share2, Copy, Check } from 'lucide-react';
          ...
          <>
            ...
            <div className="p-4 bg-white border-t border-slate-100 sticky bottom-0 z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
              <div className="flex gap-2">
                <button onClick={handleCopy} className="flex-1 py-3 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl font-bold transition-all flex items-center justify-center gap-2 active:scale-95">
