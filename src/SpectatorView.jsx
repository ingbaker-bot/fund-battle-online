// 2025v12.4 - 玩家端 (冠軍數據同步修正版)
// ★ 修正重點：比賽結束時，強制使用伺服器(主持人)結算的最終 ROI，
// 避免因玩家端本地天數延遲導致的成績不一致 (例如: 大螢幕14% vs 手機11%)
...
export default function AppBattle() {
  ...
  // ★ v12.4 修正：
  // 冠軍只有在主持人宣布結束後(寫入 finalWinner)才會出現。
  // 此時伺服器數據為「最終官方版」，玩家端應無條件顯示該數據，確保與大螢幕同步。
  // 移除「如果是自己就顯示本地數據」的邏輯。
