  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 flex justify-between items-start p-8 pb-2">
            ...
            {/* ★★★ 修改處：寬度加大 ★★★ */}
            {/* 原本是 w-28 (112px)，改為 w-36 (144px)，增加約 30px */}
            <div className="bg-white/80 p-2 rounded-xl shadow-sm flex items-center justify-center w-36 h-14 backdrop-blur-sm">
                {LOGO_BASE64 ? (
                    <img src={LOGO_BASE64} alt="Logo" className="w-full h-full object-contain" />
                ) : (
                    <div className="flex flex-col items-center justify-center text-blue-600">
                        <TrendingUp size={24} />
                        <span className="text-[8px] font-bold">NBS-奈AI團隊</span>
                    </div>
                )}
            </div>
        </div>
